  ...
  return (
    <div ref={containerRef} className='w-full h-[100dvh] bg-black  fixed top-0 left-0 z-[9999]'>
      ...
      <div className='w-full h-full flex items-end max-sm:items-center max-sm:justify-center justify-start p-[3vw]'>
        <div className='w-[10vw] h-[10vw] max-md:w-[20vw] max-md:h-[20vw] max-sm:w-[30vw] max-sm:h-[30vw] relative flex items-center justify-center bg-white/10 backdrop-blur-[10px] border-2 border-white  rounded-full'>
